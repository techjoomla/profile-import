	...
	if(JVERSION>=1.6)
	{
			class JFormFieldPathapi extends JFormField
			{
				...
				protected function getInput()
				{
					...
					if($this->id=='jform_params_pathapi_googleplus')
						return '<a href="https://code.google.com/apis/console/" target="_blank">'.JText::_('API_KEY_PATH').'</a>';
